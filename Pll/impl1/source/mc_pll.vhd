...
-- Module  Version: 5.7
--C:\lscc\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n mc_pll -lang vhdl -synth lse -arch xo2c00 -type pll -fin 9.85 -fclkop 98.5 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -fb_mode 1 -lock 
...
architecture Structure of mc_pll is
    ...
    attribute FREQUENCY_PIN_CLKOP of PLLInst_0 : label is "98.500000";
    attribute FREQUENCY_PIN_CLKI of PLLInst_0 : label is "9.850000";
...
-- synopsys translate_off
library MACHXO2;
configuration Structure_CON of mc_pll is
    for Structure
